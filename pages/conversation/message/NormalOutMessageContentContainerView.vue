<template>
	<div>
		<div class="message-time-container" v-bind:class="{ checked: sharedPickState.messages.indexOf(message) >= 0 }">
			...
			<div class="message-content-container" v-bind:class="{ checked: sharedPickState.messages.indexOf(message) >= 0 }" :style="{paddingTop: message.showAvatar ? '20px': '8px'}">
				<checkbox
					id="checkbox"
					...
					<div class="flex-column flex-align-end">
						...
						<div class="message-content-wrapper">
							<view class="receipt-status">
								<image v-if="message.status === 2" class="receipt-icon" style="opacity: 1" src="@/assets/images/send_failure.png" @click="resend" />
